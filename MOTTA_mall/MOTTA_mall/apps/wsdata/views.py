...
# """
# accept_websocket装饰器:为一个单独的视图处理一个websocket连接，它会将标准的HTTP请求路由到视图中。
# require_websocke装饰器:只允许使用WebSocket连接，会拒绝正常的HTTP请求。
# 配置MIDDLEWARE_CLASSES=dwebsocket.middleware.WebSocketMiddleware：会拒绝单独的视图实用websocket，必须加上accept_websocket 装饰器。
# 配置置WEBSOCKET_ACCEPT_ALL=True：允许每一个单独的视图实用websockets
#
# 一些方法和属性：
...
"""
list = [
            {"监控屏IO": [{"监控屏IO, 烟感": ["烟雾告警", "严重告警"]}, {"监控屏IO, 漏水": ["漏水告警", "严重告警"]},
                       {"监控屏IO, 机柜门": ["打开", "一般告警"]},
                       {"监控屏IO, 通讯状态": ["通讯中断", "一般告警"]}]},
            ...
            {"温湿度": [
                ...
                {"温湿度, 湿度": ["高湿告警", "一般告警"]},
                {"温湿度, 湿度": ["低湿告警", "一般告警"]},
                {"温湿度, 设备通讯状态": ["通讯中断", "严重告警"]}
            ]},

            {"UPS": [{"UPS, 市电异常": ["有告警", "一般告警"]}, {"UPS, 旁路/逆变": ["有效", "一般告警"]},
                     {"UPS, UPS故障": ["有告警", "一般告警"]},
                     {"UPS, EPO": ["有告警", "一般告警"]}, {"UPS, 测试状态": ["测试中", "通知"]},
                     {"UPS, 关机有效": ["有告警", "一般告警"]}, {"UPS, 电池测试失败": ["有告警", "一般告警"]},
                     {"UPS, 电池未接": ["有告警", "一般告警"]},
                     {"UPS, 电池过充": ["有告警", "一般告警"]}, {"UPS, 电池低压": ["有告警", "一般告警"]},
                     {"UPS, 输出过载": ["有告警", "一般告警"]}, {"UPS, 风扇堵转": ["有告警", "一般告警"]},
                     {"UPS, 过温": ["有告警", "一般告警"]},
                     {"UPS, 充电器故障": ["有告警", "一般告警"]},
                     {"UPS, L1输入保险开路报警": ["有告警", "一般告警"]}, {"UPS, 维护开关盖打开": ["有告警", "一般告警"]},
                     {"UPS, 设备通讯状态": ["通讯中断", "严重告警"]}]},
            {"主路电表": [{"主路电表, 设备通讯状态": ["通讯中断", "严重告警"]}]},
            {"IT负载电表": [{"IT负载电表, 设备通讯状态": ["通讯中断", "严重告警"]}]},
            {"空调": [{"空调, 吸气温度探头故障": ["故障", "一般告警"]}, {"空调, 送风温度探头故障": ["故障", "一般告警"]},
                    {"空调, 吸气压力探头故障": ["故障", "一般告警"]},
                    {"空调, 排气压力探头故障": ["故障", "一般告警"]},
                    {"空调, 回风温度探头故障": ["故障", "一般告警"]}, {"空调, 回风湿度探头故障": ["故障", "一般告警"]},
                    {"空调, 温度过高": ["故障", "一般告警"]},
                    {"空调, 送风温度过低": ["故障", "一般告警"]},
                    {"空调, 湿度过高": ["故障", "一般告警"]}, {"空调, 湿度过低": ["故障", "一般告警"]}, {"空调, 水溢报警": ["故障", "一般告警"]},
                    {"空调, 漏水报警": ["故障", "一般告警"]}, {"空调, 高压保护开关": ["故障", "一般告警"]},
                    {"空调, 低压保护开关": ["故障", "一般告警"]}, {"空调, 烟雾报警": ["故障", "一般告警"]}, {"空调, 送风机故障": ["故障", "一般告警"]},
                    {"空调, 加湿器故障": ["故障", "一般告警"]},
                    {"空调, 电加热故障": ["故障", "一般告警"]}, {"空调, 水泵故障": ["故障", "一般告警"]}, {"空调, 低压压力报警": ["故障", "一般告警"]},
                    {"空调, 电流过载": ["故障", "一般告警"]},
                    {"空调, 排气压力过高报警": ["故障", "一般告警"]}, {"空调, 压缩机内部故障": ["故障", "一般告警"]},
                    {"空调, 通讯故障": ["故障", "一般告警"]},
                    {"空调, 压缩机高压保护": ["故障", "一般告警"]},
                    {"空调, 压缩机低压保护": ["故障", "一般告警"]}, {"空调, 设备通讯状态": ["通讯中断", "严重告警"]}]}
        ]
"""
# list_eq = [
#
...
#         {"UPS, 电池电压": [{"name": "电池电压"}, {"unit": "V"}, {"max_id": 0}]},
#         {"UPS, 最大检测温度": [{"name": "最大检测温度"}, {"unit": "℃"}, {"max_id": 0}]},
#         {"UPS, UPS类型": [{"name": "UPS类型"}, {"unit": "-"}, {"0": "后备式"}, {"1": "在线互动式"}, {"10": "在线式"},
#                         {"max_id": 0}]},
#         {"UPS, 市电异常": [{"name": "市电异常"}, {"unit": "-"}, {"0": "正常"}, {"1": "告警"}, {"max_id": 0}]},
#         {"UPS, 电池低压": [{"name": "电池低压"}, {"unit": "-"}, {"0": "正常"}, {"1": "告警"}, {"max_id": 0}]},
#         {"UPS, 旁路/逆变": [{"name": "旁路/逆变"}, {"unit": "-"}, {"0": "正常"}, {"1": "有效"}, {"max_id": 0}]},
...
#         {"UPS, L1输入保险开路": [{"name": "L1输入保险开路"}, {"unit": "-"}, {"0": "正常"}, {"1": "告警"}, {"max_id": 0}]},
#         {"UPS, 维护开关盖打开": [{"name": "维护开关盖打开"}, {"unit": "-"}, {"0": "正常"}, {"1": "告警"}, {"max_id": 0}]},
#         {"UPS, UPS模式": [{"name": "UPS模式"}, {"unit": "-"}, {"80": "开机"}, {"83": "待机"}, {"89": "旁路"},
#                         {"76": "Line"},
...
#                       {"17": "Inverter软启动失败"}, {"18": "Inverter电压过高"}, {"19": "Inverter电压过低"},
#                       {"20": "L1 Inverter短路"},
#                       {"21": "L2 Inverter短路"}, {"22": "L3 Inverter短路"}, {"23": "L1L2 Inverter短路"},
#                       {"24": "L2L3 Inverter短路"}, {"25": "L3L1 Inverter短路"}, {"26": "L1 Inverter负功率超范围"},
#                       {"27": "L2 Inverter负功率超范围"}, {"28": "L3 Inverter负功率超范围"}, {"33": "电池SCR故障"},
#                       {"34": "Line SCR故障"},
#                       {"35": "Inverter继电器开路故障"}, {"36": "Inverter继电器短路故障"}, {"37": "输入输出线路接反"},
#                       {"38": "电池反接故障"},
#                       {"39": "电池电压过高"}, {"40": "电池电压过低"}, {"41": "电池FUSE开路故障"}, {"49": "CANBus通讯故障"},
#                       {"50": "主机信号线路故障"}, {"51": "同步信号线路故障"}, {"52": "同步触发信号线路故障"}, {"53": "并机通信线路丢失故障"},
#                       {"54": "输出严重不均流故障"}, {"65": "温度过高"}, {"66": "控制板中CPU间通讯故障"}, {"67": "过载故障"},
#                       {"68": "风扇模组故障"},
#                       {"69": "充电器故障"}, {"70": "机型错误"}, {"71": "控制板与通讯板MCU通讯故障"}, {"max_id": 0}]},
#         {"UPS, UPS简化模式": [{"name": "UPS简化模式"}, {"unit": "-"}, {"0": "待机/关机"}, {"1": "旁路"}, {"2": "市电"},
#                           {"3": "电池"},
#                           {"max_id": 0}]},
#         {"UPS, 设备通讯状态": [{"name": "设备通讯状态"}, {"unit": "-"}, {"0": "通讯中断"}, {"1": "通讯正常"}, {"max_id": 0}]}]},
#     {"主路电表": [
...
#         {"主路电表, 功率因数": [{"name": "功率因数"}, {"unit": "-"}, {"max_id": 0}]},
#         {"主路电表, 频率": [{"name": "频率"}, {"unit": "Hz"}, {"max_id": 0}]},
#         {"主路电表, 设备通讯状态": [{"name": "设备通讯状态"}, {"unit": "-"}, {"0": "通讯中断"}, {"1": "通讯正常"},
#                           {"max_id": 0}]}]},
#     {"IT负载电表": [
#         {"主路电表, 当前组合有功电能": [{"name": "当前组合有功电能"}, {"unit": "Kwh"}, {"max_id": 0}]},
#         {"主路电表, 当前正向有功电能": [{"name": "当前正向有功电能"}, {"unit": "Kwh"}, {"max_id": 0}]},
