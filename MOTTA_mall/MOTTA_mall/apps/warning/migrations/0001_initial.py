    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('StartCompareValue', models.CharField(default='mull', max_length=25, null=True, verbose_name='与Envtens对应')),
            ],
            options={
                'verbose_name': '实时告警列表',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('equipment_parameter', models.CharField(max_length=120, verbose_name='参数')),
