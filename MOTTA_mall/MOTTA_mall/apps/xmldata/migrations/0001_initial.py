    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('StartCompareValue', models.CharField(default=None, max_length=50)),
                ('StartOperation', models.CharField(default=None, max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Unit', models.CharField(max_length=25)),
                ('StateValue', models.CharField(blank=True, default=None, max_length=10, null=True)),
                ('Meaning', models.CharField(blank=True, default=None, max_length=50, null=True)),
                ('Signals_ip', models.CharField(max_length=50)),
                ('Signals_time', models.CharField(max_length=50)),
            ],
            options={
